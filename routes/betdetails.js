...
router.get("/:betId", (req, res, next) => {
  const q = `
  SELECT teams1.name AS team1,teams2.name AS team2,guess,bingo,cote_x,cote_1,cote_2,goals1,goals2,idBet,idMatch,gameweeks.name as gameweekname FROM betdetails
